...
* 1) From WordPress Dashboard go to "Plugins>> Add New>> Uploads", select 'sp-porfolio.zip' file and upload it. Or,
* 2) Extract the zip file, copy and paste to the 'wp-conten/plugins/' directory of your WordPress Installation. 
* 2) Activate the plugin.
* 3) Create a new page named it "Portfolio". In the editor place this shortcode [ExpandPortfolio].
